...
class displayupdate(object):
    ...
    def showtext(self,line,text):
        ...
        threadcontrol.display.write("Show text", 2)
        # threadcontrol.display.write("
...
class displayhandler(object):
    def __init__(self):
        ...
        threadcontrol.display.write("Good morning")
        print("Initiating displayhandler independentally")
        sleep(100)
    ...
    def _thread_clock(self,id):
        while True:
            ...
            threadcontrol.lock.acquire()
            try:
                threadcontrol.display.write("Hello", 1)
